...
LOCAL_DB_ENGINE = os.getenv("DB_ENGINE", "sqlite").strip().lower()

if LOCAL_DB_ENGINE == "sqlite":
    DATABASES = {
        "default": {
    ...
    raise RuntimeError("DB_ENGINE deve ser sqlite ou postgres.")
